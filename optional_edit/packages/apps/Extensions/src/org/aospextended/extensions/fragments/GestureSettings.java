...
public class GestureSettings extends SettingsPreferenceFragment implements
    ...
    private static final String KEY_LONG_SWIPE = "long_swipe_screen_off";

    private SystemSettingSwitchPreference mGesturesToggle;
    private SystemSettingSwitchPreference mLongSwipeToggle;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mLongSwipeToggle = (SystemSettingSwitchPreference) findPreference(KEY_LONG_SWIPE);
        mLongSwipeToggle.setChecked(Settings.System.getInt(getContentResolver(),
            Settings.System.OMNI_LONG_SWIPE_SCREEN_OFF, 0) == 1);
        mLongSwipeToggle.setOnPreferenceChangeListener(this);
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        ...
        } else if (preference == mLongSwipeToggle) {
            int value = ((Boolean)objValue) ? 1 : 0;
            Settings.System.putInt(getContentResolver(),
                    Settings.System.OMNI_LONG_SWIPE_SCREEN_OFF, value);
        } else {
            return false;
        }
        return true;
